...
waterDate.setDate(waterDate.getDate() + 3); // Innaffiatura ogni 3 giorni
fertilizeDate.setDate(fertilizeDate.getDate() + 30); // Concimazione ogni 30 giorni
pruneDate.setDate(pruneDate.getDate() + 180); // Potatura ogni 6 mesi
cuttingDate.setDate(cuttingDate.getDate() + 365); // Talee ogni anno
harvestDate.setDate(harvestDate.getDate() + 90); // Raccolta ogni 3 mesi
